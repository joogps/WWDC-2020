...
public class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createPowerUp(type: Int) {
        ...
        let powerup = PowerUp(frame: view!.frame, texture: "\(texture)", category: category)
        addChild(powerup)
    }
    ...
    public func didBegin(_ contact: SKPhysicsContact) {
        ...
        case projectileEnemyBitMasks:
            ...
            if score % 15 == 0 {
                Sounds.difficultyIncreaseSound?.play()
    ...
    func startSlowMotionTimer() {
        ...
        slowMotionTimer = Timer.scheduledTimer(withTimeInterval: 1.5, repeats: true) { timer in
            if self.slowMotionStresses <= 1 {
                Sounds.slowMotionTimerDone?.play()
            ...
            Sounds.slowMotionTimerTick?.play()
